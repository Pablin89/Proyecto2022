...
Public Class GraficoProdCat
    Public NombreReporte As String = "Principal.GraficoProductosCat.rdlc"
    Public FormaReporte As String = "Normal"
    Private Sub GraficoProdCat_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Public Sub Populate()
        ...
        Try
            QuerryProductos.Adaptador2.Fill(dt)

...
Partial Public Class Productos
    ...
    Partial Public Class ProductosDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Overloads Function AddProductosRow(ByVal nombre As String, ByVal descripcion As String, ByVal stock As Integer, ByVal precio As Decimal, ByVal rubro_id As Integer) As ProductosRow
            Dim rowProductosRow As ProductosRow = CType(Me.NewRow,ProductosRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, nombre, descripcion, stock, precio, rubro_id}
        ...
        Private Sub InitClass()
            ...
            Me.columnrubro_id = New Global.System.Data.DataColumn("rubro_id", GetType(Integer), Nothing, Global.System.Data.MappingType.Element)
            ...
            Me.columnrubro_id.AllowDBNull = false
    ...
    Partial Public Class ProductosRow
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Property rubro_id() As Integer
            Get
                Return CType(Me(Me.tableProductos.rubro_idColumn),Integer)
            End Get
            Set
                Me(Me.tableProductos.rubro_idColumn) = value
            End Set
        End Property
    End Class
...
Namespace ProductosTableAdapters
    ...
    Partial Public Class ProductosTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Productos] WHERE (([Id_producto] = @Original_Id_producto) AND "& _ 
                "([nombre] = @Original_nombre) AND ([stock] = @Original_stock) AND ([precio] = @O"& _ 
                "riginal_precio) AND ([rubro_id] = @Original_rubro_id))"
            ...
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Original_rubro_id", Global.System.Data.SqlDbType.Int, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "rubro_id", Global.System.Data.DataRowVersion.Original, false, Nothing, "", "", ""))
            Me._adapter.InsertCommand = New Global.System.Data.SqlClient.SqlCommand()
            Me._adapter.InsertCommand.Connection = Me.Connection
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Productos] ([nombre], [descripcion], [stock], [precio], [rubro"& _ 
                "_id]) VALUES (@nombre, @descripcion, @stock, @precio, @rubro_id);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT Id_pro"& _ 
                "ducto, nombre, descripcion, stock, precio, rubro_id FROM Productos WHERE (Id_pro"& _ 
            ...
            Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@rubro_id", Global.System.Data.SqlDbType.Int, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "rubro_id", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            Me._adapter.UpdateCommand = New Global.System.Data.SqlClient.SqlCommand()
            Me._adapter.UpdateCommand.Connection = Me.Connection
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Productos] SET [nombre] = @nombre, [descripcion] = @descripcion, [s"& _ 
                "tock] = @stock, [precio] = @precio, [rubro_id] = @rubro_id WHERE (([Id_producto]"& _ 
                " = @Original_Id_producto) AND ([nombre] = @Original_nombre) AND ([stock] = @Orig"& _ 
                "inal_stock) AND ([precio] = @Original_precio) AND ([rubro_id] = @Original_rubro_"& _ 
                "id));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT Id_producto, nombre, descripcion, stock, precio, rubro_id FROM Pro"& _ 
                "ductos WHERE (Id_producto = @Id_producto)"
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@rubro_id", Global.System.Data.SqlDbType.Int, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "rubro_id", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Original_rubro_id", Global.System.Data.SqlDbType.Int, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "rubro_id", Global.System.Data.DataRowVersion.Original, false, Nothing, "", "", ""))
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.Principal.My.MySettings.Default.ProyectoConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT Id_producto, nombre, descripcion, stock, precio, rubro_id FROM dbo.Product"& _ 
                "os"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As Productos.ProductosDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As Productos.ProductosDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As Productos.ProductosDataTable = New Productos.ProductosDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As Productos.ProductosDataTable) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataSet As Productos) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_Id_producto As Integer, ByVal Original_nombre As String, ByVal Original_stock As Integer, ByVal Original_precio As Decimal, ByVal Original_rubro_id As Integer) As Integer
            ...
            Me.Adapter.DeleteCommand.Parameters(4).Value = CType(Original_rubro_id,Integer)
        ...
        Public Overloads Overridable Function Insert(ByVal nombre As String, ByVal descripcion As String, ByVal stock As Integer, ByVal precio As Decimal, ByVal rubro_id As Integer) As Integer
            ...
            Me.Adapter.InsertCommand.Parameters(4).Value = CType(rubro_id,Integer)
        ...
        Public Overloads Overridable Function Update(ByVal nombre As String, ByVal descripcion As String, ByVal stock As Integer, ByVal precio As Decimal, ByVal rubro_id As Integer, ByVal Original_Id_producto As Integer, ByVal Original_nombre As String, ByVal Original_stock As Integer, ByVal Original_precio As Decimal, ByVal Original_rubro_id As Integer, ByVal Id_producto As Integer) As Integer
            If (nombre Is Nothing) Then
                Throw New Global.System.ArgumentNullException("nombre")
            Else
            ...
            Me.Adapter.UpdateCommand.Parameters(4).Value = CType(rubro_id,Integer)
            ...
            Me.Adapter.UpdateCommand.Parameters(9).Value = CType(Original_rubro_id,Integer)
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal nombre As String, ByVal descripcion As String, ByVal stock As Integer, ByVal precio As Decimal, ByVal rubro_id As Integer, ByVal Original_Id_producto As Integer, ByVal Original_nombre As String, ByVal Original_stock As Integer, ByVal Original_precio As Decimal, ByVal Original_rubro_id As Integer) As Integer
            Return Me.Update(nombre, descripcion, stock, precio, rubro_id, Original_Id_producto, Original_nombre, Original_stock, Original_precio, Original_rubro_id, Original_Id_producto)
        End Function
    End Class
    ...
    Partial Public Class TableAdapterManager
        ...
        Private Function UpdateUpdatedRows(ByVal dataSet As Productos, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow), ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            ...
            If (Not (Me._productosTableAdapter) Is Nothing) Then
                Dim updatedRows() As Global.System.Data.DataRow = dataSet._Productos.Select(Nothing, Nothing, Global.System.Data.DataViewRowState.ModifiedCurrent)
        ...
        Private Function UpdateInsertedRows(ByVal dataSet As Productos, ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._productosTableAdapter) Is Nothing) Then
                Dim addedRows() As Global.System.Data.DataRow = dataSet._Productos.Select(Nothing, Nothing, Global.System.Data.DataViewRowState.Added)
        ...
        Private Function UpdateDeletedRows(ByVal dataSet As Productos, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._productosTableAdapter) Is Nothing) Then
                Dim deletedRows() As Global.System.Data.DataRow = dataSet._Productos.Select(Nothing, Nothing, Global.System.Data.DataViewRowState.Deleted)
